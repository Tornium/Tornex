...
defmodule Tornex.SpecQuery do
  ...
  the [torngen_elixir_client](https://hex.pm/packages/torngen_elixir_client) library to your
  dependencies; this library includes the paths and schemas required to make and parse APIv2
  calls. Alternatively, to make APIv2 calls without the OpenAPI specification, use
