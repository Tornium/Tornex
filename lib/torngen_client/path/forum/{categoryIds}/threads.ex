defmodule Torngen.Client.Path.Forum.CategoryIds.Threads do
  @moduledoc """
  ...
  @response_modules [ForumThreadsResponse]
  ...
  @impl true
  defparameter :categoryIds, value do
    # Category id or a list of category ids (comma separated)
    {:path, :categoryIds, value}
  end
