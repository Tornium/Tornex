defmodule Torngen.Client.Path.Faction.TerritoryWarId.Territorywarreport do
  @moduledoc """
  ...
  @response_modules [FactionTerritoryWarReportResponse]
  ...
  @impl true
  defparameter :territoryWarId, value do
    # Territory war id
    {:path, :territoryWarId, value}
  end
