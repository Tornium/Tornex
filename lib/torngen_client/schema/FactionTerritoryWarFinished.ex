defmodule Torngen.Client.Schema.FactionTerritoryWarFinished do
  ...
  @keys [:territory, :target, :start, :result, :id, :factions, :end]
  ...
  def parse(%{} = data) do
    %__MODULE__{
      ...
      result:
        data |> Map.get("result") |> Torngen.Client.Schema.parse(Torngen.Client.Schema.FactionTerritoryWarResultEnum),
  ...
  defp validate_key?(:factions, value) do
    Torngen.Client.Schema.validate?(value, {:array, Torngen.Client.Schema.FactionTerritoryWarFinishedFaction})
  end
