defmodule Torngen.Client.Schema.RacingRacesResponse do
  ...
  def parse(%{} = data) do
    %__MODULE__{
      races: data |> Map.get("races") |> Torngen.Client.Schema.parse({:array, Torngen.Client.Schema.Race}),
      _metadata:
  ...
  defp validate_key?(:races, value) do
    Torngen.Client.Schema.validate?(value, {:array, Torngen.Client.Schema.Race})
  end
